=head1 ActivePerl 1601 -- Release Notes

Welcome, and thank you for downloading ActivePerl.  This release
corresponds to Perl version 5.16.2.
...
attempt to use extensions or PPM packages built for ActivePerl 800, 1000, 1200 and 1400
...
was installed in F</opt/ActivePerl-5.16> then the HTML documentation
would be located in F</opt/ActivePerl-5.16/html>.
